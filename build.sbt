...
lazy val jsoniter = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings(
    libraryDependencies ++= Seq(
      ...
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.13.15" % "compile-internal",
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.13.15" % "test"
    ) ++ scalaTest
  )
  .jsSettings(
    fork := false,
