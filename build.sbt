...
lazy val specs = List(
  ...
  ("org.specs2" %% "specs2-scalacheck" % "4.12.10" % "test")
)
...
lazy val core = crossProject(JSPlatform, JVMPlatform)
  ...
  .jsSettings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.specs2" %%% "specs2-scalacheck" % "4.12.9" % "test"
    )
  )
  .dependsOn(spire, io)
...
lazy val jsoniter = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings(
    libraryDependencies ++= Seq(
      ...
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.10.2" % "compile-internal",
