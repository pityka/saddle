...
lazy val jsoniter = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings(
    libraryDependencies ++= Seq(
      ...
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.13.23" % "compile-internal",
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.13.23" % "test"
    ) ++ scalaTest
  )
  .jsSettings(
    fork := false,
